...
filename='D:\\weather-stations20140101-20141231.csv'
...
print(pdf[["Stn_Name","Tx","Tm","Clus_Db"]].head(20))

print(set(labels)) # As you can see for outliers, the cluster label is -1
